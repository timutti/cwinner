...
pub static REGISTRY: &[Achievement] = &[
    ...
    Achievement {
        ...
        description: "10 commits total",
    },
    Achievement {
        id: "commit_50",
        name: "Commit Machine",
        description: "50 commits total",
    },
    Achievement {
        id: "commit_100",
        name: "Centurion",
        description: "100 commits total",
    },
    // Streaks (3)
    Achievement {
        id: "streak_5",
    ...
    Achievement {
        id: "streak_10",
        name: "Unstoppable",
        description: "10-day commit streak",
    },
    Achievement {
        id: "streak_25",
        name: "Dedicated",
        description: "25-day commit streak",
    },
    // Push (1)
    Achievement {
        id: "first_push",
    ...
    Achievement {
        id: "first_subagent",
        name: "Delegator",
        description: "Spawned a subagent with Task tool",
    },
    Achievement {
        id: "web_surfer",
        name: "Web Surfer",
        description: "Used WebSearch",
    },
    Achievement {
        id: "researcher",
        name: "Deep Researcher",
        description: "Used WebFetch",
    },
    Achievement {
        id: "mcp_pioneer",
        name: "MCP Pioneer",
        description: "Used an MCP tool",
    },
    // Claude Code advanced (5)
    Achievement {
        id: "notebook_scientist",
        name: "Data Scientist",
        description: "Used NotebookEdit",
    },
    Achievement {
        id: "todo_master",
        name: "Organized",
        description: "Used TodoWrite",
    },
    Achievement {
        id: "first_skill",
        name: "Skilled Up",
        description: "Invoked a skill or slash command",
    },
    Achievement {
        id: "first_team",
        name: "Team Player",
        description: "Created an agent team",
    },
    Achievement {
        id: "team_communicator",
        name: "Team Lead",
        description: "Sent a message to a teammate",
    },
];
...
mod tests {
    ...
    fn test_mcp_pioneer_unlocks_on_mcp_tool() {
        ...
        let unlocked =
            check_achievements(&s, &ev(EventKind::PostToolUse, Some("mcp__github__search")));
